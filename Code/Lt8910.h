...
void InitLT8900(void)
{
    ...
    delayMs(200);
    SCLK = 0;
    for (i = 0; i < 34; i++)spiWriteReg(EepromTmp[i], EepromTmp[i+i+33], EepromTmp[i+i+34]);
    //    spiWriteReg(0, 0x6f, 0xe0);
    //    spiWriteReg(1, 0x56, 0x81);
    //    spiWriteReg(2, 0x66, 0x17);
    //for (i = 3; i < 5; i++)spiWriteReg(i, EepromTmp[2 * i], EepromTmp[2 * 1 + 1]);
    //for (i = 5; i < 12; i++)spiWriteReg(i, EepromTmp[2 * i], EepromTmp[2 * 1 + 1]);
    ...
    //for (i = 12; i < 19; i++)spiWriteReg(i, EepromTmp[2 * i], EepromTmp[2 * 1 + 1]);
    ...
    //for (i = 19; i < 33; i++)spiWriteReg(i, EepromTmp[2 * i], EepromTmp[2 * 1 + 1]);
